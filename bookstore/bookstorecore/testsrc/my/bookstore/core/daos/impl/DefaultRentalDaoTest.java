...
import my.bookstore.core.services.impl.DefaultRentalService;
...
public class DefaultRentalDaoTest extends ServicelayerTransactionalTest
{
	...
	@Resource
	private DefaultRentalService defaultRentalService;
    ...
    */
	...
	public void testGetActiveRentalsForCustomer()
	{
	   ...
	   // 1. Call getActiveRentalsForCustomer() method
		// actual output
		List<RentalModel> foundRentals = defaultRentalService.getActiveRentalsForCustomer(customer);
    ...
    */
	...
	public void testGetMostRentedBooks()
	{
		...
		List<BookModel> fiveMostRented = defaultRentalService.getMostRentedBooks(5);
